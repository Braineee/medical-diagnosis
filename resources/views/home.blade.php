                      ...
                      <section>
                        <div class="container py-3">
                          <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                            ...
                            <a href="{{ route('patients.index') }}" class="text-blue">
                            <div class="row">
                    ...
                    <div class="row justify-content-center">
                      <section>
                        <div class="container py-3">
                          <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                               data-toggle="tooltip" data-placement="bottom" title="Just click this bar">
                            <a href="/newsymptoms" class="text-blue">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center v-align py-4">
                    ...
                    <div class="row justify-content-center">
                      <section>
                        <div class="container py-3">
                          <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                               data-toggle="tooltip" data-placement="bottom" title="Just click this bar">
                            <a href="/patients/{{ Auth::user()->id }}" class="text-blue">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center v-align py-4">
                      ...
                      <section>
                        <div class="container py-3">
                          <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                               data-toggle="tooltip" data-placement="bottom" title="Just click this bar">
                            <a href="/records/{{ Auth::user()->id }}" class="text-blue">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center v-align py-4">
                    ...
                    <div class="row justify-content-center">
                      <section>
                        <div class="container py-3">
                          <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                               data-toggle="tooltip" data-placement="bottom" title="Just click this bar">
                            <a href="/diagnosis" class="text-blue">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center v-align py-4">
                      ...
                      <section>
                        <div class="container py-3">
                          <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                               data-toggle="tooltip" data-placement="bottom" title="Just click this bar">
                            <a href="/doctors" class="text-blue">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 text-center v-align py-4">
